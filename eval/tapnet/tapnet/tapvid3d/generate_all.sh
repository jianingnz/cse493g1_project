...
python3 -m tapnet.tapvid3d.annotation_generation.generate_adt --output_dir=$ADT_OUTPUT_DIRECTORY --debug=$PYTHON_DEBUG --split=minival
...
python3 -m tapnet.tapvid3d.annotation_generation.generate_pstudio --output_dir=$PSTUDIO_OUTPUT_DIRECTORY --debug=$PYTHON_DEBUG --split=minival
...
python3 -m tapnet.tapvid3d.annotation_generation.generate_drivetrack --output_dir=$DT_OUTPUT_DIRECTORY --debug=$PYTHON_DEBUG --split=minival
